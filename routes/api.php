...
Route::prefix('group')->group(function ( ) {
    Route::get('/show/{group}',[GroupController::class,'show'])->name('group');
...
Route::prefix('campaign')->group(function ( ) {
    Route::get('/show/{campaign}',[CampaignController::class,'show'])->name('campaign');
...
Route::prefix('discount')->group(function ( ) {
    Route::get('/show/{discount}',[DiscountController::class,'show'])->name('discount');
